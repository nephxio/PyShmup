...
class GameState:
    ...
    def __init__(self, background_art):
        ...
        self.add_new_objects(Enemy(50, 50, 5, 2, 'enemy', 100, image=Settings.enemy_sprite_list[0]), 'enemy', 'enemy')
